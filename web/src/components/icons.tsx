// Lucide-style inline SVG icons. Stroke 1.6, 24-unit viewbox.
...
const ICONS: Record<string, ReactNode> = {
  ...
  board: <><rect x="3" y="3" width="7" height="18" rx="1"/><rect x="14" y="3" width="7" height="13" rx="1"/></>,
  workflow: <><rect x="3" y="3" width="6" height="6" rx="1"/><rect x="15" y="3" width="6" height="6" rx="1"/><rect x="9" y="15" width="6" height="6" rx="1"/><path d="M6 9v3a3 3 0 0 0 3 3h0"/><path d="M18 9v3a3 3 0 0 1-3 3h0"/></>,
  ...
  pr: <><circle cx="6" cy="6" r="3"/><circle cx="18" cy="18" r="3"/><line x1="13" y1="6" x2="18" y2="6"/><path d="M18 9v6"/><line x1="6" y1="9" x2="6" y2="21"/></>,
  ...
  diamond: <path d="M2.7 10.3a2 2 0 0 0 0 3.4l8 8a2 2 0 0 0 3.4 0l8-8a2 2 0 0 0 0-3.4l-8-8a2 2 0 0 0-3.4 0z"/>,
  ...
  fork: <><circle cx="6" cy="3" r="2"/><circle cx="6" cy="21" r="2"/><circle cx="18" cy="3" r="2"/><path d="M6 5v6a4 4 0 0 0 4 4h4a4 4 0 0 0 4-4V5"/><line x1="6" y1="15" x2="6" y2="19"/></>,
  ...
  tasks: <><polyline points="3 6 5 8 9 4"/><polyline points="3 14 5 16 9 12"/><line x1="13" y1="6" x2="21" y2="6"/><line x1="13" y1="14" x2="21" y2="14"/></>,
  refresh: <><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"/></>,
  upload: <><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></>,
  caret: <path d="M5 8 L12 15 L19 8 Z" fill="currentColor"/>,
  pen: <path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5z"/>,
  power: <><path d="M18.36 6.64a9 9 0 1 1-12.72 0"/><line x1="12" y1="2" x2="12" y2="12"/></>,
  beta: <path d="M3 22V6a4 4 0 0 1 4-4 4 4 0 0 1 4 4 4 4 0 0 1-4 4H3M3 10h6a5 5 0 0 1 5 5 5 5 0 0 1-5 5H3"/>,
  asterisk: <><line x1="12" y1="2" x2="12" y2="22"/><line x1="3.5" y1="6.5" x2="20.5" y2="17.5"/><line x1="3.5" y1="17.5" x2="20.5" y2="6.5"/></>,
  cog: <><circle cx="12" cy="12" r="3"/><path d="M12 2v3M12 19v3M5 12H2M22 12h-3M4.93 4.93l2.12 2.12M16.95 16.95l2.12 2.12M4.93 19.07l2.12-2.12M16.95 7.05l2.12-2.12"/></>,
...
export function Icon({ name, size = 16, stroke = 1.6, color = 'currentColor', style, className }: IconProps) {
  const p = ICONS[name];
  if (!p) return null;
  return (
    <svg
